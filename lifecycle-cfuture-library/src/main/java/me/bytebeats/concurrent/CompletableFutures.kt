...
fun <T, U, V> CompletableFuture<T>.thenCombineOnMainThread(
    ...
    return this.thenCombineAsync(other, fn, MainExecutor.instance())
}
...
fun <T, U> CompletableFuture<T>.thenAcceptBothOnMainThread(
    ...
    return this.thenAcceptBothAsync(other, action, MainExecutor.instance())
}
...
fun <T> CompletableFuture<T>.runAfterBothOnMainThread(
    ...
    return this.runAfterBothAsync(other, action, MainExecutor.instance())
}
...
fun <T, U> CompletableFuture<T>.applyToEitherOnMainThread(
    ...
    return this.applyToEitherAsync(other, fn, MainExecutor.instance())
}
...
fun <T> CompletableFuture<T>.acceptEitherOnMainThread(
    ...
    return this.acceptEitherAsync(other, action, MainExecutor.instance())
}
